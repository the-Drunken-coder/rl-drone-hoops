...
Examples:
  ...
  python3 train_recurrent_ppo.py --run-dir runs/my_run --resume --eval-every-steps 5000
    ...
    cfg = PPOConfig(
        ...
        auto_restart=bool(pick("auto_restart")),
        auto_restart_bad_evals=int(pick("auto_restart_bad_evals")),
        auto_restart_return_drop=float(pick("auto_restart_return_drop")),
        auto_restart_min_step=int(pick("auto_restart_min_step")),
